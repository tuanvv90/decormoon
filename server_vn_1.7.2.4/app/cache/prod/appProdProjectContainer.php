...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'db709727156.db.1and1.com', 'port' => '', 'dbname' => 'db709727156', 'user' => 'dbo709727156', 'password' => 'Abc13579@!', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b162f9eb42591af09db5edf387b1b7d48f711000ded272c0315d5afc2e396ea1');
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener($this->get('request_stack'), 'vi-VN', $this->get('prestashop.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['prestashop.core.api.category.repository'] = new \PrestaShopBundle\Entity\Repository\CategoryRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'dm_');
    }
    ...
    {
        return $this->services['prestashop.core.api.feature_attribute.repository'] = new \PrestaShopBundle\Entity\Repository\FeatureAttributeRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'dm_');
    }
    ...
    {
        return $this->services['prestashop.core.api.manufacturer.repository'] = new \PrestaShopBundle\Entity\Repository\ManufacturerRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'dm_');
    }
    ...
    {
        return $this->services['prestashop.core.api.stockmovement.repository'] = new \PrestaShopBundle\Entity\Repository\StockMovementRepository($this, $this->get('doctrine.dbal.default_connection'), $this->get('doctrine.orm.default_entity_manager'), $this->get('prestashop.adapter.legacy.context'), $this->get('prestashop.adapter.image_manager'), 'dm_');
    }
    ...
    {
        return $this->services['prestashop.core.api.supplier.repository'] = new \PrestaShopBundle\Entity\Repository\SupplierRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'dm_');
    }
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('dm_');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Ncui79mIiWy9bzxLIEAzJ0QVrR8scfmCAxr9IpxRigWSxK6KVVS9XOvD');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a0b014850bd78.25679319')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'cache.driver' => 'array',
            'database_host' => 'db709727156.db.1and1.com',
            'database_port' => '',
            'database_name' => 'db709727156',
            'database_user' => 'dbo709727156',
            'database_password' => 'Abc13579@!',
            'database_prefix' => 'dm_',
            ...
            'secret' => 'Ncui79mIiWy9bzxLIEAzJ0QVrR8scfmCAxr9IpxRigWSxK6KVVS9XOvD',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-11-14',
            'locale' => 'vi-VN',
            'cookie_key' => 'D98RVVn8Ng8CWt4xy1Cdt0wKVRc2T2Zk94DrbynNTQGEcuQPmEI00SsD',
            'cookie_iv' => 'HQk7hbVZ',
            'new_cookie_key' => 'def000001d8731b7746657c19b0029bf7fdd2a761cbb70ab6bf5238427a995039a3bb687974800a7db3ba6390054ee708ec5f26c8ebd2cdfb6dfbf7c1f83630c482a9018',
            ...
            'kernel.secret' => 'Ncui79mIiWy9bzxLIEAzJ0QVrR8scfmCAxr9IpxRigWSxK6KVVS9XOvD',
