...
<?php /*%%SmartyHeaderCode:18167733885a0b03e71f9eb0-68311001%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '18167733885a0b03e71f9eb0-68311001',
  'function' => 
  array (
    'menu' => 
    array (
  ...
  'unifunc' => 'content_5a0b03e7225f71_45892435',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a0b03e7225f71_45892435')) {function content_5a0b03e7225f71_45892435($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['_counter'] = new Smarty_variable(0, null, 0);?>
...
">
					...
					<?php if (count($_smarty_tpl->tpl_vars['node']->value['image_urls'])) {?>
...
" alt="">
		...
		<?php if ($_smarty_tpl->tpl_vars['depth']->value==0) {?>
			<?php if (Module::isInstalled("smartblog")&&Module::isInstalled("smartbloghomelatestnews")&&(Module::isEnabled("smartblog"))&&(Module::isEnabled("smartbloghomelatestnews"))) {?>
				<li class="otblog">
				<a class="dropdown-item" href="<?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getPageLink('smartblog'),'html','UTF-8'), ENT_QUOTES, 'UTF-8');?>
" data-depth="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['depth']->value, ENT_QUOTES, 'UTF-8');?>
"><?php echo smartyTranslate(array('s'=>'blog','d'=>'Shop.Theme.Global'),$_smarty_tpl);?>
</a>
				</li>
			<?php }?>
		<?php }?>
