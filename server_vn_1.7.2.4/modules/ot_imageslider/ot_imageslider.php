...
include_once(_PS_MODULE_DIR_.'ot_imageslider/Ot_HomeSlide.php');

class Ot_ImageSlider extends Module implements WidgetInterface
{
    protected $_html = '';
    protected $default_speed = 3500;
    protected $default_pause_on_hover = 1;
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'ot_imageslider';
        ...
        $this->displayName = $this->getTranslator()->trans('Onthemes - Image slider', array(), 'Modules.ImageSlider');
        $this->description = $this->getTranslator()->trans('Display Image Slider on Homepage.', array(), 'Modules.ImageSlider');
        $this->ps_versions_compliancy = array('min' => '1.7.0.0', 'max' => _PS_VERSION_);

        $this->templateFile = 'module:ot_imageslider/views/templates/hook/slider.tpl';
    }
    ...
    public function install()
    {
        ...
        if (parent::install() &&
            ...
            foreach ($shops as $shop_id) {
                ...
                $res = Configuration::updateValue('OT_HOMESLIDER_SPEED', $this->default_speed, false, $shop_group_id, $shop_id);
                $res &= Configuration::updateValue('OT_HOMESLIDER_PAUSE_ON_HOVER', $this->default_pause_on_hover, false, $shop_group_id, $shop_id);
            }

            /* Sets up Shop Group configuration */
            if (count($shop_groups_list)) {
                foreach ($shop_groups_list as $shop_group_id) {
                    $res &= Configuration::updateValue('OT_HOMESLIDER_SPEED', $this->default_speed, false, $shop_group_id);
                    $res &= Configuration::updateValue('OT_HOMESLIDER_PAUSE_ON_HOVER', $this->default_pause_on_hover, false, $shop_group_id);
                }
            }

            /* Sets up Global configuration */
            $res &= Configuration::updateValue('OT_HOMESLIDER_SPEED', $this->default_speed);
            $res &= Configuration::updateValue('OT_HOMESLIDER_PAUSE_ON_HOVER', $this->default_pause_on_hover);
    ...
    public function uninstall()
    {
        ...
        if (parent::uninstall()) {
            ...
            $res &= Configuration::deleteByName('OT_HOMESLIDER_SPEED');
            $res &= Configuration::deleteByName('OT_HOMESLIDER_PAUSE_ON_HOVER');
    ...
    protected function deleteTables()
    {
        ...
        foreach ($slides as $slide) {
            $to_del = new Ot_HomeSlide($slide['id_slide']);
            $to_del->delete();
        }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitSlide') || Tools::isSubmit('delete_id_slide') ||
            ...
            if ($mode == 'add') {
                ...
                $associated_shop_ids = Ot_HomeSlide::getAssociatedIdsShop((int)Tools::getValue('id_slide'));
    ...
    protected function _postValidation()
    {
        ...
        if (Tools::isSubmit('submitSlider')) {
            if (!Validate::isInt(Tools::getValue('OT_HOMESLIDER_SPEED'))) {
    ...
    protected function _postProcess()
    {
        ...
        if (Tools::isSubmit('submitSlider')) {
            ...
            foreach ($shops as $shop_id) {
                ...
                $res = Configuration::updateValue('OT_HOMESLIDER_SPEED', (int)Tools::getValue('OT_HOMESLIDER_SPEED'), false, $shop_group_id, $shop_id);
                $res &= Configuration::updateValue('OT_HOMESLIDER_PAUSE_ON_HOVER', (int)Tools::getValue('OT_HOMESLIDER_PAUSE_ON_HOVER'), false, $shop_group_id, $shop_id);
            }

            /* Update global shop context if needed*/
            switch ($shop_context) {
                case Shop::CONTEXT_ALL:
                    $res &= Configuration::updateValue('OT_HOMESLIDER_SPEED', (int)Tools::getValue('OT_HOMESLIDER_SPEED'));
                    $res &= Configuration::updateValue('OT_HOMESLIDER_PAUSE_ON_HOVER', (int)Tools::getValue('OT_HOMESLIDER_PAUSE_ON_HOVER'));
                    if (count($shop_groups_list)) {
                        foreach ($shop_groups_list as $shop_group_id) {
                            $res &= Configuration::updateValue('OT_HOMESLIDER_SPEED', (int)Tools::getValue('OT_HOMESLIDER_SPEED'), false, $shop_group_id);
                            $res &= Configuration::updateValue('OT_HOMESLIDER_PAUSE_ON_HOVER', (int)Tools::getValue('OT_HOMESLIDER_PAUSE_ON_HOVER'), false, $shop_group_id);
                        }
                    }
                    break;
            ...
            $slide = new Ot_HomeSlide((int)Tools::getValue('id_slide'));
            if ($slide->active == 0) {
                $slide->active = 1;
            } else {
                $slide->active = 0;
            ...
            $slide = new Ot_HomeSlide((int)Tools::getValue('delete_id_slide'));
            $res = $slide->delete();
            $this->clearCache();
            if (!$res) {
    ...
    {
        $this->context->controller->registerStylesheet('modules-othomeslider', 'modules/'.$this->name.'/views/css/flexslider.css', ['media' => 'all', 'priority' => 150]);
        $this->context->controller->registerJavascript('modules-othomeslider', 'modules/'.$this->name.'/views/js/jquery.flexslider-min.js', ['position' => 'bottom', 'priority' => 150]);
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        return [
            'othomeslider' => [
                'speed' => $config['OT_HOMESLIDER_SPEED'],
                'pause' => $config['OT_HOMESLIDER_PAUSE_ON_HOVER'] ? 'true' : 'false',
                'slides' => $slides,
            ],
        ];
    }
    ...
    public function getSlides($active = null)
    {
        ...
        foreach ($slides as &$slide) {
            $slide['image_url'] = $this->context->link->getMediaLink(_MODULE_DIR_.'ot_imageslider/views/img/'.$slide['image']);
        }
    ...
    public function renderList()
    {
        ...
        foreach ($slides as $key => $slide) {
            ...
            $associated_shop_ids = Ot_HomeSlide::getAssociatedIdsShop((int)$slide['id_slide']);
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'OT_HOMESLIDER_PAUSE_ON_HOVER',
    ...
    public function getConfigFieldsValues()
    {
        ...
        return array(
            'OT_HOMESLIDER_SPEED' => Tools::getValue('OT_HOMESLIDER_SPEED', Configuration::get('OT_HOMESLIDER_SPEED', null, $id_shop_group, $id_shop)),
            'OT_HOMESLIDER_PAUSE_ON_HOVER' => Tools::getValue('OT_HOMESLIDER_PAUSE_ON_HOVER', Configuration::get('OT_HOMESLIDER_PAUSE_ON_HOVER', null, $id_shop_group, $id_shop)),
        );
    }
