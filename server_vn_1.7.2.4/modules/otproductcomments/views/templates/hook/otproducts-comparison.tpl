...
<tr class="comparison_header">
    <td class="feature-name td_empty">
        <span>{l s='Comments' mod='otproductcomments'}</span>
    </td>
...
<tr>
    <td  class="{$classname} feature-name">
        <strong>{l s='Average' mod='otproductcomments'}</strong>
    </td>
    {foreach from=$list_ids_product item=id_product}
    ...
    {foreach from=$list_ids_product item=id_product}
        <td class="{$classname} comparison_infos product-{$id_product}" align="center">
            {if isset($product_comments[$id_product]) AND $product_comments[$id_product]}
                <a href="javascript:void(0);" rel="#comments_{$id_product}" data-id-product-comment="{$id_product|intval}" class="btn btn-primary">{l s='view comments' mod='otproductcomments'}</a>
