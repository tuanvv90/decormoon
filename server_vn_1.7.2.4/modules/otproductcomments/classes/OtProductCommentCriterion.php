...
class OtProductCommentCriterion extends ObjectModel
{
    public $id;
    ...
    */ 
    public static $definition = array(
        'table' => 'otproduct_comment_criterion',
    ...
    public function delete()
    {
        ...
        if ($this->id_product_comment_criterion_type == 2) {
            if (!Db::getInstance()->execute('
                DELETE FROM '._DB_PREFIX_.'otproduct_comment_criterion_category
                WHERE id_product_comment_criterion='.(int)$this->id)) {
                return false;
            }
        } elseif ($this->id_product_comment_criterion_type == 3) {
            if (!Db::getInstance()->execute('
                DELETE FROM '._DB_PREFIX_.'otproduct_comment_criterion_product
                WHERE id_product_comment_criterion='.(int)$this->id)) {
                return false;
            }
        }
    ...
    */
    public function addProduct($id_product)
    {
        ...
        return Db::getInstance()->execute('
            INSERT INTO `'._DB_PREFIX_.'otproduct_comment_criterion_product` (`id_product_comment_criterion`, `id_product`)
    ...
    */
    public function addCategory($id_category)
    {
        ...
        return Db::getInstance()->execute('
            INSERT INTO `'._DB_PREFIX_.'otproduct_comment_criterion_category` (`id_product_comment_criterion`, `id_category`)
    ...
    */
    public function addGrade($id_product_comment, $grade)
    {
        ...
        return (Db::getInstance()->execute('
            INSERT INTO `'._DB_PREFIX_.'otproduct_comment_grade`
    ...
    public static function getByProduct($id_product, $id_lang)
    {
        ...
        if (!Cache::isStored($cache_id)) {
            $result = Db::getInstance()->executeS('
                ...
                FROM `'._DB_PREFIX_.'otproduct_comment_criterion` pcc
                LEFT JOIN `'._DB_PREFIX_.'otproduct_comment_criterion_lang` pccl
                ON (pcc.id_product_comment_criterion = pccl.id_product_comment_criterion)
                LEFT JOIN `'._DB_PREFIX_.'otproduct_comment_criterion_product` pccp
                ON (pcc.`id_product_comment_criterion` = pccp.`id_product_comment_criterion` AND pccp.`id_product` = '.(int)$id_product.')
                LEFT JOIN `'._DB_PREFIX_.'otproduct_comment_criterion_category` pccc
    ...
    */
    public static function getCriterions($id_lang, $type = false, $active = false)
    {
        ...
        FROM `'._DB_PREFIX_.'otproduct_comment_criterion` pcc
        JOIN `'._DB_PREFIX_.'otproduct_comment_criterion_lang` pccl ON (pcc.id_product_comment_criterion = pccl.id_product_comment_criterion)
    ...
    public function getProducts()
    {
        $res = Db::getInstance()->executeS('
            ...
            FROM `'._DB_PREFIX_.'otproduct_comment_criterion_product` pccp
    ...
    public function getCategories()
    {
        $res = Db::getInstance()->executeS('
            ...
            FROM `'._DB_PREFIX_.'otproduct_comment_criterion_category` pccc
