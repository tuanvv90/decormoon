...
class Ot_Brandlogo extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'ot_brandlogo';
        ...
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = $this->trans('OT - Brand Logo',array(),'Modules.Ot_brandlogo.Admin');
        $this->description = $this->trans('Displays Brand logo on homepage.',array(),'Modules.Ot_brandlogo.Admin');
        $this->ps_versions_compliancy = array('min' => '1.7.0.0', 'max' => _PS_VERSION_);
        $this->templateFile = 'module:ot_brandlogo/views/templates/hook/ot_brandlogo.tpl';
    }

    public function install()
    {
        Configuration::updateValue('OT_BRAND_NAME', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            && Configuration::deleteByName('OT_BRAND_NAME');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitTTBlockBrandLogos')) {
			...
			Configuration::updateValue('OT_BRAND_NAME', (int)(Tools::getValue('OT_BRAND_NAME')));
			$this->_clearCache('*');
        ...
        $fields_form = array(
            'form' => array(
                ...
                'input' => array(                    
					array(
                        'type' => 'switch',
                        'label' => $this->getTranslator()->trans('Display Manufacture Name', array(), 'Modules.Ot_brandlogo.Admin'),
                        'name' => 'OT_BRAND_NAME',
                        'is_bool' => true,
						'values' => array(
                            array(
    ...
    {
        return array(
            'OT_BRAND_NAME' => (int)Tools::getValue('OT_BRAND_NAME', Configuration::get('OT_BRAND_NAME')),
        );
    }
    ...
    public function getWidgetVariables(
        ...
        return array(
			...
			'brandname' => Configuration::get('OT_BRAND_NAME'),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('ot_brandlogo');
